...
export default {
  ...
  "organizationName": "cubode",
  "projectName": "cubode-agent-docs",
  "trailingSlash": true,
  "onBrokenLinks": "throw",
  ...
  "presets": [
    [
      "classic",
      {
        "docs": {
          "routeBasePath": "/",
          "sidebarPath": "/Users/benmcloughlin/Documents/Cubode/CUBODE_AGENTS_DOCS/cubode-agent-docs/sidebars.js"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2024 Cubode Ltd."
    },
    "prism": {
      "theme": {
        "plain": {
